...
public partial class Admin_RptPagosOmitidosCDSUA : System.Web.UI.Page
{
        ...
        else
        {
            ...
            else
            {
                if (DropDownList2.SelectedValue != "")
                {
                    ...
                    Session["Tipo_Reporte"] = "Retraso_Pagos";
                    ...
                    try
                    {
                        ...
                        comando.Parameters["@tipo"].Value = "Consulta Pagos Omitidos CDSUA";
