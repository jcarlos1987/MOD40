<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterAdmin.master" AutoEventWireup="true" CodeFile="Carga_CD-SUA.aspx.cs" Inherits="Admin_Carga_CD_SUA" %>
    ...
    <!--grids-->
				<div class="grids">
					<div class="progressbar-heading grids-heading">
						<h2>Carga del Archivo CD-SUA</h2>
					</div>
								...
								<div class="validation-grids widget-shadow" data-example-id="basic-forms"> 
									...
									<div class="form-body form-body-info">
										<form data-toggle="validator">
											...
											<div class="form-group">
                                                <asp:Button ID="Cargar" CssClass="btn btn-primary disabled" runat="server" Text="Cargar" onclick="Button1_Click" />
											</div>
