...
public partial class Admin_RptpagoxperiodNC : System.Web.UI.Page
{
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Session["Reporte"] = "Periodo";
        Session["NssPerio"] = nss;
        ...
        try
        {
            ...
            comando.Parameters["@tipo"].Value = "Consulta Pagos Periodo Nivel Central";
