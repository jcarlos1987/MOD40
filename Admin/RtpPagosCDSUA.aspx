<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPage.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="RtpPagosCDSUA.aspx.cs" Inherits="Admin_RtpPagosCDSUA" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="grids">
        <div class="progressbar-heading grids-heading">
            <h2>Reporte de Pagos Realizados (CD-SUA)</h2>
        </div>
        <div class="panel panel-widget">
					...
					<div class="col-md-12 program-grid">
						<div class="panel panel-widget">
                            ...
                            <div class="table table-responsive">
                             <asp:GridView ID="GridView1" runat="server" EnableSortingAndPagingCallbacks="false" CssClass="table table-bordered table-responsive" AutoGenerateColumns="False" Visible="false" 
                        DataSourceID="SqlDataSource1" AllowPaging="True" BackColor="White" PagerStyle-CssClass="gridViewPaginacion" 
                        BorderColor="#999999" BorderStyle="None"  BorderWidth="1px" CellPadding="3" 
                        GridLines="Vertical"
                        DataKeyNames="RCAS_NUM_AFIL,RCPS_PATRON,RCAS_NOM_TRAB" 
                        onselectedindexchanged="GridView1_SelectedIndexChanged" PageSize="15" Font-Size="12px">
                        ...
                        <SortedDescendingHeaderStyle BackColor="#000065" />
                          <Columns>
                            <asp:BoundField DataField="RCAS_NUM_AFIL" HeaderText="NSS" SortExpression="RCAS_NUM_AFIL" />
                            <asp:BoundField DataField="RCPS_PATRON" HeaderText="Registro Patronal" SortExpression="RCPS_PATRON" />
                            <asp:BoundField DataField="RCAS_NOM_TRAB" HeaderText="Nombre del Trabajador" SortExpression="RCAS_NOM_TRAB" />
                              <asp:TemplateField HeaderText="Detalles" HeaderStyle-CssClass="center-align">
                                <ItemTemplate>
                                    <asp:LinkButton ID="LinkButton1" CommandName="Select" runat="server" CausesValidation="false" ><button type="button" class="btn btn-xs btn-success warning_4">Reporte <i class="fa fa-file-pdf-o"></i></button></asp:LinkButton>
                                </ItemTemplate>
            ...
            <div class="alert alert-danger" role="alert">
								<strong>Mensaje!</strong> No se encontraron Resultados .
							   </div>
        </emptydatatemplate> 
                    </asp:GridView>
                                </div>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:MOD40_CDSUAConnectionString %>" 
                        SelectCommand="SELECT DISTINCT T1.RCAS_NUM_AFIL, T2.RCPS_PATRON, T1.RCAS_NOM_TRAB FROM CDSUAS AS T1 LEFT OUTER JOIN CDSUPA AS 
                                        T2 ON T1.RCAS_CVE_UNIT = T2.RCPS_CVE_UNIT WHERE (T1.RCAS_CVE_UNIT = T2.RCPS_CVE_UNIT) AND
                            (T1.RCAS_NOM_TRAB LIKE '%' + @nombre + '%') OR (T1.RCAS_NUM_AFIL LIKE '%' + @nombre + '%') ORDER BY T1.RCAS_NOM_TRAB ASC">
                        <SelectParameters>
