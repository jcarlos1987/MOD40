<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPage.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="RptPagosOmitidosNC.aspx.cs" Inherits="Admin_RptPagosOmitidos" %>
...
<ul class="nav" id="side-menu">
        ...
        <li>
            ...
            <ul class="nav nav-second-level collapse">
                ...
                <li><a href="SolicCertPago.aspx">Certificación de Pagos</a></li>
            </ul>
            <!-- /nav-second-level -->
        </li>
        <li>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="grids">
        <div class="progressbar-heading grids-heading">
            <h2>Reporte de Pagos Omitidos (Base Div. de Reg. y Admon. de App.)</h2>
        </div>
											...
											<div class="col-md-12">
												<div class="input-group">							
                                                    ...
                                                    <asp:DropDownList ID="DropDownList2" runat="server" class="form-control1">
                                                        <asp:ListItem Value="00" disabled selected >-- Seleciona el Tipo --</asp:ListItem>
                                                    </asp:DropDownList>													
												</div>
											</div>
                                            <label class="col-md-2 control-label">Seleccione una Opción : </label>
												...
												<div class="input-group">							
													<span class="input-group-addon">
                                                        ...
                                                        <asp:DropDownList ID="DropDownList1" runat="server" class="form-control1" >
                                                            <asp:ListItem Value="00" disabled selected >-- Seleciona el numero de meses omitidos  --</asp:ListItem>                                                            
                                                        </asp:DropDownList>											
												</div>
											</div>
										</div>
