<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPage.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="Rpt_Pagos_RealizadosNivCent.aspx.cs" Inherits="Admin_Rpt_Pagos_RealizadosNivCent" %>
...
<div class="grids">
        <div class="progressbar-heading grids-heading">
            <h2>Reporte de Pagos Realizados (Base Div. de Reg. y Admon. de App.)</h2>
        </div>
						...
						<div class="panel panel-widget">
							...
							<div class="panel-body">
								...
								<form class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-10">
                                            <asp:Button ID="Button1" CssClass="btn btn-primary" runat="server" OnClick="Button1_Click" Text="Consultar" />
                                            </div>
											</div>
                                        </div>
                                    </form>
