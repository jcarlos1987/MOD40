...
public partial class Admin_ImportDocument_RptPagosxPeriodoCDSUA : System.Web.UI.Page
{
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        string nss = Convert.ToString(GridView1.DataKeys[row.RowIndex].Values["RCAS_NUM_AFIL"]);
        string reg = Convert.ToString(GridView1.DataKeys[row.RowIndex].Values["RCPS_PATRON"]);
        string nom = Convert.ToString(GridView1.DataKeys[row.RowIndex].Values["RCAS_NOM_TRAB"]);
        Session["Tipo_Reporte"] = "PagosxPeriodo";
        Session["nss_pagos"] = nss;
        ...
        try
        {
            ...
            comando.Parameters["@tipo"].Value = "Consulta Pagos Periodo CDSUA";
            ...
            Response.Write("<script>window.open('Reporte.aspx','_blank');</script>");
        }
