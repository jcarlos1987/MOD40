<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPage.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="RptPagosxAnioCDSUA.aspx.cs" Inherits="Admin_RptPagosxAnioCDSUA" %>
...
<div class="grids">
        <div class="progressbar-heading grids-heading">
            <h2>Reporte de Pagos por Año (CD-SUA)</h2>
        </div>
					...
					<div class="col-md-12 program-grid">
						<div class="panel panel-widget">
                            ...
                            <div class="table table-responsive">
                                 <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-responsive" AutoGenerateColumns="False" Visible="false" 
                        DataSourceID="SqlDataSource1" AllowPaging="True" BackColor="White" PagerStyle-CssClass="gridViewPaginacion" 
                        BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" Font-Size="12px"
                        GridLines="Vertical" 
